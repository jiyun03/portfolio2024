...
export default function BusinessCard({ cardColor }: { cardColor: string }) {
  ...
  // 폰트 설정
  const fontPath = '/fonts/AppleSDGothicNeo/AppleSDGothicNeoM.ttf'
  const fontPathSB = '/fonts/AppleSDGothicNeo/AppleSDGothicNeoSB.ttf'
  ...
  return (
    ...
    >
      ...
      <Text position={[-1.3, -1.02, 0.06]} fontSize={0.1} anchorX="center" anchorY="middle" color="white" font={fontPath}>
      ...
      <Plane args={[3.5, 2]} position={[0, 0, -0.05]} rotation={[0, Math.PI, 0]}>
        ...
        <Text position={[-1.6, -0.23, 0.01]} fontSize={0.3} color="white" anchorX="center" anchorY="middle" font={fontPathSB}>
          박지윤
        </Text>
        <Text position={[-0.7, -0.27, 0.01]} fontSize={0.15} color="white" anchorX="center" anchorY="middle" font={fontPath}>
          PARK JIYUN
        </Text>
        <Text position={[-1.3, -0.6, 0.01]} fontSize={0.2} color="white" anchorX="center" anchorY="middle" font={fontPath}>
          010-6610-8728
        </Text>
        <Text position={[-1.1, -0.9, 0.01]} fontSize={0.2} color="white" anchorX="center" anchorY="middle" font={fontPath}>
          sprare06@gmail.com
        </Text>
      </Plane>
    </group>
