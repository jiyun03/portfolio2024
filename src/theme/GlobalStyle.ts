...
export const GlobalStyle = createGlobalStyle`
  ...
  @font-face {
    ...
    font-weight: 600;
    src: url('/fonts/SaolDisplay/SaolDisplay-Regular.woff2');
    src: url('/fonts/SaolDisplay/SaolDisplay-Regular.woff2') format('woff2'),
        ...
        url('/fonts/SaolDisplay/SaolDisplay-Regular.svg}#Montserrat-SemiBold') format('svg');
  }
  // AppleSDGothicNeo
  @font-face {
    ...
    font-weight: 100;
    src: 
      url('/fonts/AppleSDGothicNeo/AppleSDGothicNeoT.woff2') format('woff2'),
  ...
  @font-face {
    ...
    font-weight: 300;
    src: 
      url('/fonts/AppleSDGothicNeo/AppleSDGothicNeoL.woff2') format('woff2'),
  ...
  @font-face {
    ...
    font-weight: 600;
    src: 
    url('/fonts/AppleSDGothicNeo/AppleSDGothicNeoSB.woff2') format('woff2'),
  ...
  @font-face {
    ...
    font-weight: 700;
    src: 
      url('/fonts/AppleSDGothicNeo/AppleSDGothicNeoB.woff2') format('woff2'),
  ...
  @font-face {
    ...
    font-weight: 800;
    src: 
      url('/fonts/AppleSDGothicNeo/AppleSDGothicNeoEB.woff2') format('woff2'),
  ...
  @font-face {
    ...
    font-weight: 900;
    src: 
      url('/fonts/AppleSDGothicNeo/AppleSDGothicNeoH.woff2') format('woff2'),
